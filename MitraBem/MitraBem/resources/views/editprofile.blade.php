                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="{{ asset('assets/300-3.jpg') }}" alt="image" />
                                <div
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <div
                                            class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ Auth::user()->name }}</div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px"
                                            style="background-image: url(assets/media/avatars/300-22.jpg)"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="phone"
                                            ...
                                            placeholder="No Telepon" value={{ Auth::user()->number }}>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="overflow-auto pb-5">
                                        <div
                                            ...
                                            <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                <!--begin::Icon-->
                                                <img alt="../../demo10/dist/apps/projects/project.html"
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="fs-5 fw-semibold mb-2">New case
                                            ...
                                            in Multi-platform Database Design project</div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="overflow-auto pb-5">
                                            <!--begin::Wrapper-->
                                ...
                                <div class="timeline-content mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="fs-5 fw-semibold mb-2">New order
                                            ...
                                            Workshow Planning & Budget Estimation</div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            <!--begin::Info-->
                ...
                <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex flex-column me-3">
                            <!--begin::Section-->
                            <div class="mb-3">
                                <a href="../../demo10/dist/apps/ecommerce/sales/details.html"
                                    ...
                                    <div class="pt-5 tab-pane fade show active"
                                        ...
                                        <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                            ...
                                            <div class="row gy-10">
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/marketing.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/social.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/ecommerce.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/store-analytics.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/logistics.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/delivery.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/online-courses.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/school.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/crypto.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/finance-performance.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/website-analytics.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/bidding.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/podcast.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/projects.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/call-center.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-md-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/dashboards/pos.html" data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                            class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                    ...
                                    <div class="pt-5 tab-pane fade" id="kt_app_engage_prebuilts_tab_apps"
                                        ...
                                        <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                            ...
                                            <div class="row gy-10">
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/projects/list/list.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/ecommerce/catalog/products/products.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/customers/list/list.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/subscriptions/list/list.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/user-management/users/list/list.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/invoices/create/main.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/support-center/overview/main.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/chat/private.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/calendar/calendar.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/file-manager/list/folders.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/inbox/listing/listing.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                                ...
                                                <div class="col-lg-4">
                                                    <!--begin::Preview-->
                                                    <a href="../../demo10/dist/apps/contacts/getting-started.html"
                                                        data-kt-href="true"
                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        <!--begin::Title-->
                                                        <h3
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/layouts/corporate/sign-in.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/layouts/creative/sign-in.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/layouts/fancy/sign-in.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/layouts/overlay/sign-in.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/extended/multi-steps-sign-up.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/extended/two-factor-auth.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/password-confirmation.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/verify-email.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/welcome.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/coming-soon.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/account-deactivated.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/error-404.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/general/error-500.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <div class="show"
                                                            ...
                                                            <div class="row g-10 pt-2 pb-5">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/user-profile/overview.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/user-profile/projects.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/user-profile/campaigns.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/user-profile/documents.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/user-profile/followers.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <div class="collapse"
                                                            ...
                                                            <div class="row g-10 pt-2 pb-5">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/about.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/contact.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/licenses.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/team.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/sitemap.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <div class="collapse"
                                                            ...
                                                            <div class="row g-10 pt-2 pb-5">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/social/feeds.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/social/activity.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/social/followers.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/social/settings.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <div class="collapse"
                                                            ...
                                                            <div class="row g-10 pt-2 pb-5">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/faq/classic.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/faq/extended.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/blog/home.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <!--begin::Preview-->
                                                                    <a href="../../demo10/dist/pages/blog/post.html"
                                                                        data-kt-href="true"
                                                                        class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                        <!--begin::Title-->
                                                                        <h3
                                                ...
                                                <div class="tab-pane fade"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/overview.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/settings.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/billing.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/security.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/referrals.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/logs.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/account/api-keys.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                ...
                                                <div class="tab-pane fade" id="kt_app_engage_prebuilts_tab_pages_modals"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/general/view-users.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/general/upgrade-plan.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/top-up-wallet.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/general/share-earn.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/general/select-users.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/forms/bidding.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/offer-a-deal.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/forms/new-target.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/forms/new-card.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/forms/new-address.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/general/invite-friends.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/create-project.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/create-campaign.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/create-account.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/create-app.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/forms/create-api-key.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/modals/wizards/two-factor-authentication.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                ...
                                                <div class="tab-pane fade"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/wizards/horizontal.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/wizards/vertical.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                ...
                                                <div class="tab-pane fade" id="kt_app_engage_prebuilts_tab_pages_search"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/search/users.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/search/horizontal.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/search/vertical.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/utilities/search/select-location.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                ...
                                                <div class="tab-pane fade"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/widgets/charts.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/widgets/feeds.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/widgets/lists.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/widgets/mixed.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/widgets/statistics.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/widgets/tables.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                ...
                                                <div class="tab-pane fade"
                                                    ...
                                                    <div class="row g-10">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/welcome-message.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/subscription-confirmed.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/reset-password.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/card-declined.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/promo-1.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/promo-2.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                                        ...
                                                        <div class="col-lg-4">
                                                            <!--begin::Preview-->
                                                            <a href="../../demo10/dist/authentication/email/promo-3.html"
                                                                data-kt-href="true"
                                                                class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                <!--begin::Title-->
                                                                <h3
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/index.html">Launcher</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/marketing.html">Marketing
                                                        Dashboard</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/social.html">Social
                                                        Dashboard</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/ecommerce.html">eCommerce
                                                        Dashboard</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/store-analytics.html">Store
                                                        Analytics</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/logistics.html">Logistics</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/delivery.html">Delivery</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/online-courses.html">Online
                                                        Courses</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/school.html">Hello Tyler</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/crypto.html">My Balance:
                                                        37,045$</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/finance-performance.html">Finance
                                                        Performance</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/website-analytics.html">Website
                                                        Analytics</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/bidding.html">Bidding
                                                        Dashboard</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/podcast.html">Podcast
                                                        Dashboard</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/projects.html">Projects
                                                        Dashboard</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/call-center.html">Call
                                                        Center</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/dashboards/pos.html">POS System</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/layouts/corporate/sign-in.html">Corporate</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/layouts/creative/sign-in.html">Creative</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/layouts/fancy/sign-in.html">Fancy</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/layouts/overlay/sign-in.html">Overlay</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/extended/multi-steps-sign-up.html">Multi-step</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/extended/two-factor-auth.html">2
                                                        Factor Auth</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/password-confirmation.html">Password
                                                        Changed</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/verify-email.html">Verify
                                                        Email</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/welcome.html">Welcome</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/coming-soon.html">Coming
                                                        Soon</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/account-deactivated.html">Account
                                                        Deactivated</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/error-404.html">404
                                                        Page</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/general/error-500.html">505
                                                        Page</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/overview.html">Overview</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/settings.html">Settings</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/billing.html">Billing</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/security.html">Security</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/referrals.html">Referrals</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/logs.html">Logs</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/api-keys.html">API Keys</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/statements.html">Statements</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/account/billing.html">Billing</a>
                                                </div>
                                                <!--end::List-->
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/general/view-users.html">View
                                                        Friends</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/general/upgrade-plan.html">Upgrade
                                                        Plan</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/top-up-wallet.html">Topup
                                                        Wallet</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/general/share-earn.html">Share
                                                        & Earn</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/general/select-users.html">Select
                                                        User</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/forms/bidding.html">Place
                                                        Bid</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/offer-a-deal.html">Offer
                                                        Deal</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/forms/new-target.html">New
                                                        Target</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/forms/new-card.html">New
                                                        Card</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/forms/new-address.html">New
                                                        Address</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/general/invite-friends.html">Invite
                                                        Friend</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/create-project.html">Create
                                                        Project</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/create-campaign.html">Create
                                                        Campaign</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/create-account.html">Create
                                                        Business Account</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/create-app.html">Create
                                                        App</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/forms/create-api-key.html">Create
                                                        Api Key</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/modals/wizards/two-factor-authentication.html">2
                                                        Factor Auth</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/wizards/horizontal.html">2
                                                        Factor Auth</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/wizards/horizontal.html">Horizontal</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/wizards/vertical.html">Vertical</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/search/users.html">Search
                                                        Users</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/search/horizontal.html">Search
                                                        Horizontal</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/search/vertical.html">Search
                                                        Vertical</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/utilities/search/select-location.html">Search
                                                        Location</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/widgets/charts.html">Charts</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/widgets/feeds.html">Feeds</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/widgets/lists.html">Lists</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/widgets/mixed.html">Mixed</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/widgets/statistics.html">Statistics</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/widgets/tables.html">Tables</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/welcome-message.html">Welcome</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/subscription-confirmed.html">Subscription
                                                        Confirmed</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/reset-password.html">Reset
                                                        Password</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/card-declined.html">Card
                                                        Declined</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/promo-1.html">Promotion
                                                        1</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/promo-2.html">Promotion
                                                        2</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/authentication/email/promo-3.html">Promotion
                                                        3</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/user-profile/overview.html">Profile
                                                        Overview</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/user-profile/projects.html">User
                                                        Projects</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/user-profile/campaigns.html">User
                                                        Campaigns</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/user-profile/documents.html">User
                                                        Documents</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/user-profile/followers.html">User
                                                        Followers</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/user-profile/activity.html">User
                                                        Activity</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/about.html">About Us</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/contact.html">Contact Us</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/licenses.html">License</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/team.html">Our Team</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/sitemap.html">Sitemap</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/social/feeds.html">Activity</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/social/activity.html">Feeds</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/social/followers.html">Followers</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/social/settings.html">Settings</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                    ...
                                    <div class="mb-10 mb-lg-17">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/faq/classic.html">FAQ Classic</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/faq/extended.html">FAQ
                                                        Extended</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/blog/home.html">Blog Home</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/pages/blog/post.html">Blog Post</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/projects/list/list.html.html">Projects</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/ecommerce/catalog/products/products.html.html">Ecommerce</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/customers/list/list.html.html">Customers</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/subscriptions/list/list.html.html">Subscriptions</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/user-management/users/list/list.html.html">User
                                                        Management</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/invoices/create/main.html.html">Invoices</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/support-center/overview/main.html.html">Support
                                                        Center</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/chat/private.html.html">Chat</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/calendar/calendar.html.html">Calendar</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="d-flex flex-column gap-3 gap-lg-5">
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/file-manager/list/folders.html.html">File
                                                        Manager</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/inbox/listing/listing.html.html">Inbox</a>
                                                    <a class="fw-6 fw-semibold"
                                                        href="../../demo10/dist/../../demo10/dist/apps/contacts/getting-started.html.html">Contacts</a>
                                                </div>
                                                <!--end::List-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                        <div class="fw-bold text-gray-800">Get more messages on chat
                                                        </div>
                            ...
                            <form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate"
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <!--begin::Illustration-->
                                        <div class="text-center px-4">
                                            <img src="assets/media/illustrations/sigma-1/20.png" alt=""
                                                class="mw-100 mh-300px" />
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                            ...
                            <div class="pb-10">
                                ...
                                <label
                                    ...
                                    <span class="d-block fw-semibold text-start">
                                        ...
                                        <span class="text-muted fw-semibold fs-6">We will send a code via SMS if you
